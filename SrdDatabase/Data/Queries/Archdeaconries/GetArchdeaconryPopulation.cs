...
namespace SrdDatabase.Data.Queries.Archdeaconrys
{
    public class GetArchdeaconryPopulation
    {
        ...
        public class Handler : IRequestHandler<Query, Population>
        {
            ...
            private readonly string _storedProcedure = "sto_get_archdeaconry_population";
