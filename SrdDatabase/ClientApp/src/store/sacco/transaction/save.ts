...
const SET_IS_LOADING = 'TRANSACTION.SET_IS_LOADING';
const SET_TRANSACTION = 'TRANSACTION.SET_TRANSACTION';
const SET_MEMBER_ID = 'TRANSACTION.SET_MEMBER_ID';
const SET_IS_SHARES = 'TRANSACTION.SET_IS_SHARES';
const SET_IS_CONTRIBUTION = 'TRANSACTION.SET_IS_CONTRIBUTION';
const SET_AMOUNT = 'TRANSACTION.SET_AMOUNT';
const SET_DATE = 'TRANSACTION.SET_DATE';
const SET_RECEIPT_NUMBER = 'TRANSACTION.SET_RECEIPT_NUMBER';
